...
export default {
    ...
    methods: {
        toggleDropdown(dropdownName) {
            ...
            for (let name in this.dropdowns) {
            ...
            <div class="row row-nav justify-content-between">
                ...
                <div class="col-8">
                    <ul class="d-flex">
                                    ...
                                    <div class="col-6">
                                        <li class="img-drop">
                                            <a href="#"
                                                ><img
                                                    class="img-drop"
                                                    src="https://maxcoach.thememove.com/main/wp-content/uploads/sites/1/2020/05/homepages-mega-menu-image-alt.jpg"
                                                    alt=""
                                            /></a>
                                        </li>
                                    </div>
                        ...
                        <li @click="toggleDropdown('courses')">
                            Courses
                            <i class="fa-solid fa-chevron-down"></i>
                            <ul
